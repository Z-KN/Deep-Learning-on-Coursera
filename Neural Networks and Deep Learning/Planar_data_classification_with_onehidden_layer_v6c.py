...
def initialize_parameters(n_x, n_h, n_y):
    ...
    b1 = np.zeros(shape=(n_h,1))#note the different expression of the two initialization methods
...
def forward_propagation(X, parameters):
    ...
    A1 = np.tanh(Z1)
    Z2 = np.dot(W2,A1)+b2
    A2 = sigmoid(Z2)#last layer is classification, use sigmoid
    ### END CODE HERE ###
...
def predict(parameters, X):
    ...
    ### START CODE HERE ### (≈ 2 lines of code)
    A2, cache = forward_propagation(X, parameters)
    predictions = np.round(A2)#note the expression
    ### END CODE HERE ###
